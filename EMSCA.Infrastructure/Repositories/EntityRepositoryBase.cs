...
namespace EMSCA.Application.Repositories
{
    public abstract class EntityRepositoryBase<TContext, TEntity> : BaseRepository<TContext>, IRepository<TEntity> where TContext : DbContext where TEntity : BaseEntity, new()
    {
